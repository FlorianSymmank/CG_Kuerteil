...
namespace CG_Kuerteil
{
    ...
    {
        //private static int cubeVertexArrayID = -1;
        private int _CubeVertexBuffer;
        private static int _CubeVertexArrayID = -1;
        ...
        public Cube(Container parent, Shader shader) : base(shader)
        {
            if (_CubeVertexArrayID == -1)
            {
